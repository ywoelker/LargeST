...
class BigSTPreprocess(BaseModel):
    """
    ...
    def __init__(self, input_length, output_length, in_dim, num_nodes, nhid, tiny_batch_size, dropout=0.3):
        super(BigSTPreprocess, self).__init__(node_num=num_nodes, input_dim=in_dim, output_dim=1, seq_len=input_length, horizon=output_length)
        self.tau = 1.0
        self.layer_num = 3
