...
import metrics
from models.graphsparsenet.model import GSNet
...
class train_pipeline():
    def __init__(self, scaler, seq_num, in_dim, hid_dim, num_nodes, tau, random_feature_dim, node_emb_dim, time_emb_dim, \
        ...
        self.model = GSNet(device, seq_num, in_dim, hid_dim, num_nodes, tau, random_feature_dim, node_emb_dim, time_emb_dim, \
