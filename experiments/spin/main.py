...
from src.models.spin.models.spin_hierarchical import SPINHierarchicalModel
from src.engines.spin_engine import SPIN_Engine
...
def get_config():
    ...
    args.model_name = 'SPIN-H' if args.model_name == '' else args.model_name
...
def main():
    ...
    model = SPINHierarchicalModel(
        input_size = args.input_dim - 2, # minus time embedding u
        h_size=32,
        z_size=128,
        z_heads=4,
        u_size=2,
    ...
    engine = SPIN_Engine(device=device,
                          model=model,
